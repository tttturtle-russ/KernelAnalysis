...
0. I am working on a function pair, the {FUNC1} and {FUNC2} itself in the driver "{DRIVER}".
...
1. It is easy for you to find out the ioctl/syscall that can trigger the function of {FUNC1} in the driver "{DRIVER}".
...
3. Even the func1 and func2 are same, but pay attention to the json file and check whether the line I want to trigger in the pair are same, if so, you can regard them as same, if not, please generate them Targetedly.
